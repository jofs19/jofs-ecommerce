                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <img id="showImage" src="{{ (!empty($activeVendorDetails->profile_photo_path))? url($activeVendorDetails->profile_photo_path):url('upload/no_image.jpg') }}" style="width: 100px; height: 100px; border: 1px solid #000000;">
