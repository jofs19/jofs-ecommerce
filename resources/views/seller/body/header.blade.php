    ...
    <div class="navbar navbar-expand-lg navbar-dark">
      <div class="container"><a class="navbar-brand d-none d-sm-block flex-shrink-0 me-4 order-lg-1" href="{{ route('vendor.dashboard') }}"><img src="{{ asset('frontendv2/assets/img/logo5.svg') }}" width="100" alt="PCBUILD"></a><a class="navbar-brand d-sm-none me-2 order-lg-1" href="{{ route('vendor.dashboard') }}"><img src="{{ asset('frontendv2/assets/img/logo5.svg') }}" width="70" alt="PCBUILD"></a>
            ...
            <div class="navbar-toolbar d-flex align-items-center order-lg-3">
                ...
                <div class="navbar-tool ms-4"><a class="navbar-tool-icon-box bg-secondary dropdown-toggle" href="marketplace-cart.html"><span class="navbar-tool-label">3</span><i class="navbar-tool-icon ci-bell"></i></a></div>
              </div>
  ...
  <div class="page-title-overlap bg-dark pt-4">
    <div class="container d-flex flex-wrap flex-sm-nowrap justify-content-center justify-content-sm-between align-items-center pt-2">
      <div class="d-flex align-items-center pb-3">
        <div class="img-thumbnail rounded-circle position-relative flex-shrink-0" style="width: 6.375rem;"><img class="rounded-circle" src="{{ (!empty($vendorData->profile_photo_path)) ? asset($vendorData->profile_photo_path):url('upload/no_image.jpg') }}" alt="Createx Studio"></div>
        <div class="ps-3">
            {{-- member since --}}
