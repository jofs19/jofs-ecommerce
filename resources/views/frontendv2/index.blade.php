                ...
                <a class="card-img-top d-block overflow-hidden" href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
                    ...
                    <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            @else
                            <div class="product-price"><span class="text-accent"> ₱ {{ $product->discount_price }}
                                    <small>.00</small></span>
        ...
        <div class="col-md-5">
            <div class="d-flex flex-column h-100 overflow-hidden rounded-3" style="background-color: #f6f8fb;">
                <div class="d-flex justify-content-between px-grid-gutter py-grid-gutter">
                    <div>
                        <h3 class="mb-3">For Women</h3>
                        {{-- <a class="fs-md" href="shop-grid-ls.html">Shop for women<i
                                class="ci-arrow-right fs-xs align-middle ms-1"></i></a> --}}
                        <!-- Widget: Tag cloud -->
                        <div class="widget">
                            <a href="#" class="btn-tag active me-2 mb-2">All Categories</a>

                            @foreach ($categories as $category) 
                            <a href="#" class="btn-tag me-2 mb-2">{{ $category->category_name_en }}</a>
                            ...
                            <div class="col-lg-4 col-6 px-0 px-sm-2 mb-sm-4">
                                ...
                                <div class="card product-card card-static">
                                    ...
                                    <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1"
                                            href="#">Cosmetics</a>
                                        <h3 class="product-title fs-sm"><a href="shop-single-v1.html">{{$item->product_name_en}}</a></h3>
                                        <div class="d-flex justify-content-between">
    ...
    <div class="row">
            ...
            <div class="widget">
                ...
                <div class="d-flex align-items-center pb-2 border-bottom"><a class="d-block flex-shrink-0"
                        href="shop-single-v2.html"><img
                            src="{{ asset('frontendv2/assets/img/shop/cart/widget/05.jpg') }}" width="64"
                            alt="Product"></a>
                    <div class="ps-2">
                        <h6 class="widget-product-title"><a href="shop-single-v2.html">Wireless Bluetooth Headphones</a>
                        </h6>
                ...
                <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block flex-shrink-0"
                        href="shop-single-v2.html"><img
                            src="{{ asset('frontendv2/assets/img/shop/cart/widget/06.jpg') }}" width="64"
                            alt="Product"></a>
                    <div class="ps-2">
                ...
                <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block flex-shrink-0"
                        href="shop-single-v2.html"><img
                            src="{{ asset('frontendv2/assets/img/shop/cart/widget/07.jpg') }}" width="64"
                            alt="Product"></a>
                    <div class="ps-2">
                ...
                <div class="d-flex align-items-center py-2"><a class="d-block flex-shrink-0"
                        href="shop-single-v2.html"><img
                            src="{{ asset('frontendv2/assets/img/shop/cart/widget/08.jpg') }}" width="64"
                            alt="Product"></a>
                    <div class="ps-2">
        ...
        <div class="col-md-4 col-sm-6 mb-2 py-3">
            <div class="widget">
                ...
                <div class="d-flex align-items-center pb-2 border-bottom"><a class="d-block flex-shrink-0"
                        href="shop-single-v2.html"><img src="{{ asset('frontendv2/assets/img/shop/widget/06.jpg') }}"
                ...
                <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block flex-shrink-0"
                        href="shop-single-v2.html"><img src="{{ asset('frontendv2/assets/img/shop/widget/07.jpg') }}"
                            width="64" alt="Product"></a>
                    <div class="ps-2">
                        <h6 class="widget-product-title"><a href="shop-single-v2.html">Laserjet Printer All-in-One</a>
                        </h6>
                ...
                <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block flex-shrink-0"
                        href="shop-single-v2.html"><img src="{{ asset('frontendv2/assets/img/shop/widget/08.jpg') }}"
                            width="64" alt="Product"></a>
                    <div class="ps-2">
                        <h6 class="widget-product-title"><a href="shop-single-v2.html">Console Controller Charger</a>
                        </h6>
                ...
                <div class="d-flex align-items-center py-2"><a class="d-block flex-shrink-0"
                        href="shop-single-v2.html"><img src="{{ asset('frontendv2/assets/img/shop/widget/09.jpg') }}"
                            width="64" alt="Product"></a>
                    <div class="ps-2">
        ...
        <div class="col-md-4 col-sm-6 mb-2 py-3">
            <div class="widget">
                ...
                <div class="d-flex align-items-center pb-2 border-bottom"><a class="d-block flex-shrink-0"
                        href="shop-single-v2.html"><img src="{{ asset('frontendv2/assets/img/shop/widget/10.jpg') }}"
                            width="64" alt="Product"></a>
                    <div class="ps-2">
                ...
                <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block flex-shrink-0"
                        href="shop-single-v2.html"><img src="{{ asset('frontendv2/assets/img/shop/widget/11.jpg') }}"
                            width="64" alt="Product"></a>
                    <div class="ps-2">
                        <h6 class="widget-product-title"><a href="shop-single-v2.html">Wireless Bluetooth Headphones</a>
                        </h6>
                ...
                <div class="d-flex align-items-center py-2 border-bottom"><a class="d-block flex-shrink-0"
                        href="shop-single-v2.html"><img src="{{ asset('frontendv2/assets/img/shop/widget/12.jpg') }}"
                            width="64" alt="Product"></a>
                    <div class="ps-2">
                ...
                <div class="d-flex align-items-center py-2"><a class="d-block flex-shrink-0"
                        href="shop-single-v2.html"><img src="{{ asset('frontendv2/assets/img/shop/widget/13.jpg') }}"
                            width="64" alt="Product"></a>
                    <div class="ps-2">
...
<section class="container mt-1 mb-grid-gutter">
    <div class="bg-faded-info rounded-3 py-4">
        <div class="row align-items-center">
            ...
            <div class="col-md-7"><img src="{{ asset('frontendv2/assets/img/home/banners/offer.jpg') }}"
