      ...
      <div class="container">
        ...
        <div class="row pb-2">
          <div class="col-md-6 text-center text-md-start mb-4">
            <div class="text-nowrap mb-4"><a class="d-inline-block align-middle mt-n1 me-2" href="#"><img class="d-block" src="{{ asset('frontendv2/assets/img/vartouhi-logoss.png') }}" width="117" alt="Cartzilla"></a>
              <div class="btn-group dropdown disable-autohide">
                <button class="btn btn-outline-light border-light btn-sm dropdown-toggle px-2" type="button" data-bs-toggle="dropdown"><img class="me-2" src="{{ asset('frontendv2/assets/img/flags/en.png') }}" width="20" alt="English">Eng / $</button>
                <ul class="dropdown-menu my-1">
                  ...
                  <li><a class="dropdown-item pb-1" href="#"><img class="me-2" src="{{ asset('frontendv2/assets/img/flags/fr.png') }}" width="20" alt="Français">Français</a></li>
                  <li><a class="dropdown-item pb-1" href="#"><img class="me-2" src="{{ asset('frontendv2/assets/img/flags/de.png') }}" width="20" alt="Deutsch">Deutsch</a></li>
                  <li><a class="dropdown-item" href="#"><img class="me-2" src="{{ asset('frontendv2/assets/img/flags/it.png') }}" width="20" alt="Italiano">Italiano</a></li>
                </ul>
              </div>
            </div>
          ...
          <div class="col-md-6 text-center text-md-end mb-4">
            <div class="mb-3"><a class="btn-social bs-light bs-twitter ms-2 mb-2" href="#"><i class="ci-twitter"></i></a><a class="btn-social bs-light bs-facebook ms-2 mb-2" href="#"><i class="ci-facebook"></i></a><a class="btn-social bs-light bs-instagram ms-2 mb-2" href="#"><i class="ci-instagram"></i></a><a class="btn-social bs-light bs-pinterest ms-2 mb-2" href="#"><i class="ci-pinterest"></i></a><a class="btn-social bs-light bs-youtube ms-2 mb-2" href="#"><i class="ci-youtube"></i></a></div><img class="d-inline-block" src="{{ asset('frontendv2/assets/img/cards-alt.png') }}" width="187" alt="Payment methods">
          </div>
        </div>
